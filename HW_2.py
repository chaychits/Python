...
reeult_mp_s_root = math.pow(item_2, 0.5)

#  18. Вывести result_mp_s_root в консоль.
print(reeult_mp_s_root)
...
result_m_floor = math.floor(result_division)    #либо result_m_floor = int(result_division)
...
#print(b_item_relult_division)
 #(пункты 56 и 57 закомичены, так как выводят в консоль ошибку)
